...
class rssFeed{
	...
	function errorReturn($error){
		...
		$retVal="<?xml version=\"1.0\" ?>\n".
			...
			"\t\t<pubdate>".date("d F Y H:i")."</pubdate>\n".

			"\t\t<lastbuilddate>".date("d F Y H:i")."</lastbuilddate>\n".
	...
	function show(){
		...
		echo "<div id='box'>";
			...
			if($this->description)
				...
				echo "<dt id='discript'>$this->description</dt>";
...

			{
				...
				echo substr($this->pubdate, 5, 12);

				echo substr($this->pubdate, -14, 5);
