...
let defaultBasePath = 'http://jessemichael.me/v1';
...
export class DefaultApi {
     ...
     * @summary Get feed
     */
    public async getFeed (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Array<FeedItems>;  }> {
